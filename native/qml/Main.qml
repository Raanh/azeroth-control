    ...
    Item {
        ...
        Rectangle {
            ...
            Column {
                ...
                Text { visible: root.installProviderId === "azerothcore-coa"; width: 940 * root.s; text: "Requires your own matching Ascension native-v4 client with Extensions.dll. The installer backs up the supported DLL, applies the local-realm compatibility fix, and extracts matching CoA DBC data from your client. CoA support is experimental; the client is never downloaded by Azeroth Control."; color: root.gold; font.pixelSize: 15 * root.s; wrapMode: Text.Wrap }
