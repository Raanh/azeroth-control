    ...
    Item {
        ...
        Rectangle {
            ...
            Column {
                ...
                Text { visible: root.installProviderId === "azerothcore-coa"; width: 940 * root.s; text: "Requires your own matching Ascension native-v4 client with Extensions.dll. The installer verifies and backs up the supported DLL before applying the local-realm compatibility fix. CoA support is experimental; the client is never downloaded by Azeroth Control."; color: root.gold; font.pixelSize: 15 * root.s; wrapMode: Text.Wrap }
