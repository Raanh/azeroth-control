...
> native test build is [v0.4.0-preview.24](https://github.com/Raanh/azeroth-control/releases/tag/v0.4.0-preview.24);
...
1. Open the [Releases](https://github.com/raanh/azeroth-control/releases) page
   and download both:
   - `Azeroth-Control-0.4.0-preview.24-x86_64.AppImage`
